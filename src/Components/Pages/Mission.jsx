...
const missions = [
  {
    year: "1957",
    title: "In 1957, the Soviet Union (USSR)launched history's first artificial satellite, Sputnik 1, on October 4, 1957. This was the first manned mission to orbit Earth, marking the beginning of the Space Age. Laika, a dog, was subsequently sent into space by the Sputnik 2 mission on November 3, 1957. ",
    image: "https://images.tv9hindi.com/wp-content/uploads/2023/11/lyca-first-dog-to-flight-in-space.jpg",
    color: "#4a9eff",
  },
  {
    year: "1958",
    title: "The most prominent space mission of 1958 was Explorer 1, the first successful satellite launched by the United States on January 31, 1958. Additionally, 1958 saw the founding of NASA (July 29) and the launch of SCORE, the first communications satellite. This year marked America's beginning in the space race.",
    image: "https://images.tv9hindi.com/wp-content/uploads/2023/08/whatsapp-image-2023-08-22-at-17.27.57.jpeg",
    color: "#6eb5ff",
  },
  {
    year: "1961",
    title: "The most historic mission in 1961 was the Soviet Union's Vostok1mission, which carried Yuri Gagarin into space and became the first human to orbit the Earth on April 12, 1961. The United States also achieved its first manned spaceflight that year, with Alan Shepard's Freedom 7 mission on May 5, 1961.",
  ...
  {
    year: "1966",
    title: "Gemini 8 was launched on March 16, 1966, with astronauts Neil Armstrong and David Scott aboard. This mission achieved the first docking of two spacecraft in space when Gemini 8 successfully docked with the unmanned Agena Target Vehicle, which had been launched earlier that same day.",
    image: "https://resize.indiatv.in/resize/newbucket/1200_-/2019/07/d-2jianwsaaihxw-1563587711.jpg",
    color: "#c0c0c0",
  },
  {
    year: "1969",
    title: "In 1969, the historic Apollo 11 mission took humans to the Moon for the first time. Neil Armstrong and Buzz Aldrin walked on the Moon on July 20, 1969, while Michael Collins orbited above in the Command Module. This mission was a major achievement for space exploration and humanity.",
    image: "https://cf-img-a-in.tosshub.com/lingo/gnt/images/story/202207/copy_of_chhathh_12-sixteen_nine.jpg?size=948:533",
    color: "#ffd700",
  },
  {
    year: "1975",
    title: "1975 saw two major historic space missions: India's first satellite, Aryabhata (April 19), and the joint US-Soviet Apollo-Soyuz Test Project (July 15-24). Also launched were NASA's Viking 1 and 2 (to Mars) and the Soviet Venera 9 and 10 (to Venus), marking key steps in space exploration.",
  ...
  {
    year: "1977",
    title: "In 1977, NASA launched Voyager 1 and Voyager 2 spacecraft to study Jupiter and Saturn. These probes are still sending signals, and Voyager 1 is the farthest human-made object from Earth. Their mission helps scientists understand our solar system and its outer planets.",
    image: "https://ychef.files.bbci.co.uk/1280x720/p05cpd0y.jpg",
    color: "#7bc8ff",
  },
  {
    year: "1981",
    title: "NASA's most prominent and historic mission in 1981 was STS-1 (Space Shuttle Columbia), which took place from April 12-14, 1981. It was the first reusable spacecraft, flown by John Young and Robert Crippen. Voyager 2 also returned images of Saturn in 1981.",
    image: "https://i.ytimg.com/vi/SS7MNPWES-E/maxresdefault.jpg",
    color: "#ff8c42",
  },
  {
    year: "1995",
    title: "In 1995, NASA launched the Hubble Space Telescope, which has provided unprecedented images and data about the universe, offering truly remarkable scientific discoveries and helping scientists understand galaxies, stars, and cosmic phenomena in far greater detail.",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJqrWqb2JPzZmXE8L8EI3xPt3JqjVl_O-C7A&s",
    color: "#d4a574",
  },
  {
    year: "1998",
    title: "James Newman, a mission specialist, flew on the STS-88 mission, which launched on December 4, 1998, at 2:35 a.m. (CST) aboard the Space Shuttle Endeavour. The mission’s goal was to deliver the Unity node to the International Space Station (ISS).",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSyZUgdVUBTilISAjrJsT9Ga2hrwBMfVR4cpg&s",
    color: "#88ccff",
  },
  {
    year: "2014",
    title: "In 2014, ISRO made history by successfully placing Mangalyaan into Mars orbit.That year, NASA, SpaceX, and the European Space Agency also achieved major milestones like the Orion test flight and a comet landing.",
    image: "https://spacedoutclassroom.com/wp-content/uploads/2021/08/mars-global-surveyor-art-s.jpg",
    color: "#aaaaaa",
  },
  {
    year: "2015",
    title: "In 2015, NASA’s New Horizons mission made history by flying past Pluto and sending its first close-up images.That same year, ISRO launched the Astrosat space telescope, and the European Space Agency continued major operations like the Rosetta comet mission.",
    image: "https://images.unsplash.com/photo-1517976487492-5750f3195933?w=400&q=80",
    color: "#ffffff",
  },
  {
    year: "2020s",
    title: "In 2022, NASA successfully operated the newly deployed James Webb Space Telescope, capturing its first deep-space images.The agency also launched the Artemis I mission to test the Orion spacecraft around the Moon, while ISRO and the European Space Agency carried out multiple satellite launches and science missions.",
