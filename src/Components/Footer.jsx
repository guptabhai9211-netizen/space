...
const EXPLORE = [
  ...
  { label: "Exoplanets", href: "#" },
  { label: "Deep Space", href: "#" },
  { label: "Black Holes", href: "#" },
];
...
/* ── Footer Link ──────────────────────────────────────────── */
function FooterLink({ href, label, color = "#a78bfa", index }) {
    ...
    <>
      <style>{`
        ...
        .sf-shoot {
          ...
          border-radius: 1px;
          animation: sf-shoot-anim var(--dur) var(--del) linear infinite;
          opacity: 0;
        }
        @keyframes sf-shoot-anim {
          0%   { opacity: 0; width: 0; transform: translate(0,0) rotate(var(--ang)); }
          5%   { opacity: 1; }
          60%  { opacity: 0.6; width: 120px; }
        ...
        .sf-top-glow {
          ...
          animation: sf-glow-slide 5s linear infinite;
          overflow: visible;
        }
        ...
        .sf-logo {
          ...
          letter-spacing: 0.12em; color: #e9d5ff;
        ...
        .sf-logo-rocket {
          font-size: 1.5rem;
          animation: sf-rocket 2.5s ease-in-out infinite;
        ...
        .sf-tagline {
          ...
          color: rgba(196,181,253,0.5); margin-bottom: 28px; max-width: 280px;
        }
        ...
        .sf-status-dot {
          ...
          animation: sf-status-blink 1.8s ease-in-out infinite;
          flex-shrink: 0;
        }
        ...
        .sf-status-label {
          ...
          letter-spacing: 0.18em; color: #22c55e;
        }
        .sf-status-name {
          font-size: 0.78rem; color: rgba(196,181,253,0.7);
          padding-left: 17px;
        }
        .sf-status-bar-track {
          height: 3px; border-radius: 2px;
          background: rgba(255,255,255,0.05); margin-top: 8px;
        }
        .sf-status-bar-fill {
          height: 100%; border-radius: 2px;
          background: linear-gradient(90deg, #22c55e, #4ade80);
          box-shadow: 0 0 8px #22c55e;
          animation: sf-bar-pulse 2s ease-in-out infinite alternate;
        }
        ...
        .sf-col-head {
          ...
          color: #e9d5ff; margin-bottom: 20px;
        ...
        .fl-underline {
          ...
          height: 1px; border-radius: 1px; transform-origin: left;
        }
        ...
        .sf-nl-desc {
          ...
          color: rgba(196,181,253,0.5); margin-bottom: 18px;
        }
        .sf-nl-input-wrap {
        ...
        .sf-nl-input.focused {
          ...
          box-shadow: 0 0 20px rgba(109,40,217,0.25), inset 0 0 20px rgba(109,40,217,0.05);
        }
        .sf-nl-btn {
          ...
          box-shadow: 0 6px 24px rgba(109,40,217,0.4), inset 0 1px 0 rgba(255,255,255,0.1);
          transition: all 0.3s;
          display: flex; align-items: center; justify-content: center; gap: 8px;
        }
        .sf-nl-btn:hover {
          transform: translateY(-2px);
          box-shadow: 0 10px 32px rgba(109,40,217,0.6), inset 0 1px 0 rgba(255,255,255,0.15);
        }
        .sf-nl-success {
          display: flex; align-items: center; gap: 10px;
          ...
          color: #4ade80;
          font-family: 'Orbitron', monospace; font-size: 0.62rem; letter-spacing: 0.1em;
        }
        .sf-nl-perks {
        ...
        .sf-nl-perk {
          display: flex; align-items: center; gap: 8px;
          font-size: 0.72rem; color: rgba(167,139,250,0.5);
        }
        ...
        .sf-mid-line {
          ...
          background: linear-gradient(90deg, transparent, rgba(139,92,246,0.2), rgba(79,70,229,0.2), transparent);
        }
        ...
        .sf-copyright {
          font-family: 'Orbitron', monospace; font-size: 0.55rem;
          letter-spacing: 0.15em; color: rgba(167,139,250,0.35);
        }
        .sf-bottom-links {
          display: flex; gap: 24px; flex-wrap: wrap; justify-content: center;
        }
        .sf-bottom-link {
          font-size: 0.72rem; color: rgba(167,139,250,0.4);
        ...
        .sf-bottom-badge {
          ...
          letter-spacing: 0.12em; color: rgba(167,139,250,0.5);
        }
        .sf-bottom-badge-dot {
        ...
        /* ── Planet row decoration ── */
        .sf-planet-strip {
          position: relative; z-index: 10; overflow: hidden;
          height: 2px;
          background: linear-gradient(90deg,
            transparent 0%,
            #c2944a 8%, transparent 10%,
            #e8a45a 18%, transparent 20%,
            #4a9eca 28%, transparent 30%,
            #c1440e 38%, transparent 40%,
            #c8956c 50%, transparent 52%,
            #d4a96a 60%, transparent 62%,
            transparent 100%
          );
          opacity: 0.4;
          margin: 0 32px;
        ...
        .sf-grid-lines {
          ...
          mask-image: linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.3) 40%, rgba(0,0,0,0.3) 80%, transparent 100%);
        }
      `}</style>
      ...
      <footer className="sf-root">
        ...
        {/* Shooting stars */}
        {SHOOTS.map(s => (
          <div key={s.id} className="sf-shoot" style={{
        ...
        <div className="sf-grid" ref={footerRef}>
          ...
          >
            <a href="#home" className="sf-logo">
              <span className="sf-logo-rocket">🚀</span>
              SPACE<span className="sf-logo-acc">SITE</span>
            </a>

            <p className="sf-tagline">
              Explore galaxies, planets, and the deepest mysteries of the cosmos through our immersive space platform.
            </p>
          ...
          >
            ...
            <ul className="sf-links">
              {NAV.map((n, i) => (
                <FooterLink key={n.label} href={n.href} label={n.label} color="#a78bfa" index={i} />
              ))}
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="sf-links" style={{ marginBottom: 32 }}>
              {EXPLORE.map((n, i) => (
                <FooterLink key={n.label} href={n.href} label={n.label} color="#818cf8" index={i} />
              ))}
            </ul>
            <div className="sf-col-head" style={{ marginTop: 8 }}>Resources</div>
            <ul className="sf-links">
              {RESOURCES.map((n, i) => (
                <FooterLink key={n.label} href={n.href} label={n.label} color="#c084fc" index={i} />
              ))}
            </ul>
          </motion.div>
          ...
          >
            ...
            <p className="sf-nl-desc">
              Weekly intel on launches, discoveries, and cosmic events — beamed directly to your inbox.
            </p>
              ...
              {!submitted ? (
                ...
                >
                  <div className="sf-nl-input-wrap">
                    <input
                      type="email"
                      className={`sf-nl-input ${focused ? "focused" : ""}`}
                      ...
                      style={{
                        border: `1px solid ${focused ? "rgba(139,92,246,0.6)" : "rgba(139,92,246,0.18)"}`,
                      }}
                    />
                  </div>
                  <motion.button
                  ...
                  <div className="sf-nl-perks">
                    {["Weekly mission briefings", "Exclusive JWST imagery", "No spam, ever"].map((p, i) => (
                      <div key={i} className="sf-nl-perk">
                        <div className="sf-nl-perk-dot" />
                        {p}
                      </div>
                    ))}
                  </div>
        ...
        {/* Mid divider */}
        <div className="sf-mid-divider">
          <hr className="sf-mid-line" />
        </div>
        ...
        >
          <div className="sf-copyright">
            © 2026 SPACESITE • ALL SYSTEMS OPERATIONAL
          </div>
          ...
          <div className="sf-bottom-badge">
            <div className="sf-bottom-badge-dot" />
            ALL SYSTEMS NOMINAL
          </div>
        </motion.div>
